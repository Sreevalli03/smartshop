...
CREATE TABLE IF NOT EXISTS `smartshop`.`product` (
  ...
  `aisle` VARCHAR(15) NULL DEFAULT NULL,
  ...
  `rate_per_quantity` VARCHAR(15) NULL DEFAULT NULL,
  `shelf` VARCHAR(15) NULL DEFAULT NULL,
  `stock_count` VARCHAR(15) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `smartshop`.`purchase_history` (
  ...
  `product_product_code` VARCHAR(50) NOT NULL,
